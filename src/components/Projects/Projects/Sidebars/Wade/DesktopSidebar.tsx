...
export default function DesktopSidebar() {
  return (
    <motion.div
      ...
      className='w-full xl:w-72 xl:pb-5 rounded-xl hidden xl:flex items-center gap-8 flex-col outline outline-2 outline-purple-400 bg-purple-400/10 backdrop-blur-sm shadow-xl shadow-purple-400/50 sticky top-10 '
    >
