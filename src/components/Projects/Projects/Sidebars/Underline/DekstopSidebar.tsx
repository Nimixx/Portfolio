...
export default function DesktopSidebar() {
  return (
    <motion.div
      ...
      className="w-full xl:w-72 xl:pb-5 rounded-xl hidden xl:flex items-center gap-8 flex-col outline outline-2 outline-blue-400 bg-blue-400/5 shadow-xl shadow-blue-400/20 "
    >
