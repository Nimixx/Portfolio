...
import SasImg from '../../../../../assets/sass.svg';
...
export default function DesktopSidebar() {
  return (
    <motion.div
      ...
      className="w-full xl:w-72 xl:pb-5 rounded-xl hidden xl:flex items-center gap-8 flex-col outline outline-2 outline-blue-400 bg-blue-400/10 backdrop-blur-sm shadow-xl shadow-blue-400/50 "
    >
      ...
      <div className="grid grid-rows-7 grid-cols-1 gap-8">
        ...
        <div className="grid grid-rows-2 grid-cols-3 gap-3">
          <img
            src={ReactImg}
            alt=""
            className="w-16 px-1.5 react rounded-lg shadow-lg shadow-sky-400/20 hover:shadow-sky-400/40 hover:shadow-xl hover:-translate-y-1 duration-500"
          />
          <img
            src={JsImg}
            alt=""
          ...
          <img
            src={SasImg}
            alt=""
            className="w-16 px-1.5 py-2  rounded-lg shadow-lg shadow-pink-400/20 hover:shadow-pink-400/40 hover:shadow-xl hover:-translate-y-1 duration-500"
          />
          <img
            src={ViteImg}
            alt=""
