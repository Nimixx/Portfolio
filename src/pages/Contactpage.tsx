    ...
    <div className="w-full min-h-screen flex__center gap-20 -mt-28 ">
      ...
      >
        ...
        <ul className="text-gray-400 text-2xl flex-center gap-4">
          <li className="hover:-translate-y-1 duration500">
            <a
              className=" link-one"
      ...
      <motion.section
        ...
        whileInView={{ opacity: 1, translateX: 0 }}
        transition={{ duration: 0.3 }}
        className="flex-start-start flex-col gap-3 w-1/4"
      >
        ...
        <p className="text-gray-400 text-lg font-base">
          ...
          co pro Vás mohu udělat. Teším se na Vaše nápady.
        </p>
        <p className="text-gray-400  text-lg font-base">
          Kontaktovat mně můžete vždy pomocí emailu, nebo klidně jakékoliv
          sociální sitě.
        </p>
        <h2 className="text-yellow-300 text-xl font-semibold">
          Email: info@nimixx.cz
        </h2>
        <h2 className="text-purple-300 text-xl font-semibold">IČO: 17427631</h2>
      </motion.section>
    </div>
  );
}
