...
import UnderlineWeb from '../../src/assets/Underline_Website.webp';
import DesktopSidebar from '../components/Projects/Projects/Sidebars/Underline/DekstopSidebar';
import MobileSidebar from '../components/Projects/Projects/Sidebars/Underline/MobileSidebar';

export default function UnderlinePage() {
  ...
  return (
    <div className='min-w-full'>
      ...
      <div className='m-auto w-full xl:w-3/5 flex justify-center items-center xl:justify-start xl:items-start flex-col xl:flex-row mt-20 gap-14'>
        ...
        >
          <h2 className='sky-blue project__heading'>Underline-videoprod.cz</h2>
          ...
          <img
            src={UnderlineWeb}
            alt=''
            className='rounded-xl my-5 outline  outline-2 outline-blue-400/50 shadow-lg shadow-blue-400/50'
          />
          <h3 className='lime-green tertiary__heading'>Postup</h3>
          <p className='text-gray-200 text-lg'>
