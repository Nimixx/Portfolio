...
import DesktopSidebar from '../components/Projects/Projects/Sidebars/Nimixx/DesktopSidebar';
import MobileSidebar from '../components/Projects/Projects/Sidebars/Nimixx/MobileSidebar';
  ...
  return (
    <div className='min-w-full'>
      ...
      <div className='m-auto w-full xl:w-3/5 flex justify-center items-center xl:justify-start xl:items-start flex-col xl:flex-row mt-20 gap-14'>
        ...
        >
          <h2 className='sky-blue project__heading'>Nimixx.cz</h2>
